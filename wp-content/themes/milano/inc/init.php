	...
	public static function init()
	{
		 ...
		 */
		{
			...
			if ( defined( 'FW' ) ) {
				...
				include_once get_template_directory() . '/inc/includes/core-classes/fw-resize.php';
			}
		}
	...
	public static function _action_widgets_init()
	{
		...
		foreach ($paths as $path) {
			...
			foreach ($dirs as $dir) {
				...
				$widget_class = 'Modesto_Widget_' . self::dirname_to_classname( $dirname );
